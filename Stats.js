...
votesCasted = async () => {
    let votesCasted = await this.state.VotingInstance.methods.totalVotesCasted().call();
    this.setState({votesCasted: votesCasted});
}

totalAbstain = async () => {
    let totalAbstain = await this.state.VotingInstance.methods.totalAbstain().call();
    this.setState({totalAbstain: totalAbstain});
}

totalReject = async () => {
    let totalReject = await this.state.VotingInstance.methods.totalReject().call();
