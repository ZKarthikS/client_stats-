...
class Vote extends Component {
  ...
  render() {
    ...
    return (
      <div className="App text-center background-blue-ex">
        ...
        <div className="form">
          <FormGroup>
            ...
            <div className="col-md-4 mb-4 text-center">
            <Button onClick={this.abstain} className="button-vote" variant="secondary">
              Abstain
            </Button>
            </div>
            <div className="col-md-4 mb-4 text-center">
            <Button onClick={this.reject} className="button-vote" variant="danger">
              Reject
            </Button>
            </div>
            </div>
